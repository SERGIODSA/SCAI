<?php 
	...
	echo('<script>var loca = '.$_SESSION['Localizaciones'].'</script>');
	$url = "'BuscarLoca.php'";
	$par = "''";
	$cont = "'resultados'";
?>
...
<head>
	...
	<title>Localizaciones | Distribuidora Universal Kia C.A.</title>
...
<body onload="EnvioGet(<?php echo($url); ?>,<?php echo($par); ?>,<?php echo($cont); ?>);">
	<div class="titulo">
		&nbsp;&nbsp;<input type="image" src="../../Imagenes/Inicio.png" style="vertical-align: middle;" onclick="cambio_pagina('../Menu.php');"><span style="vertical-align: middle;"> - Mantenimiento - Localizaciones</span>
	</div>
