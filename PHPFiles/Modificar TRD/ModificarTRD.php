<?php
	...
	echo('<script>var modificar = '.$_SESSION['ModificarTRD'].'</script>');
...
<head>
	...
	<title>Modificacion de Tabla de Retencion Documental | Distribuidora Universal Kia, C.A.</Title>
...
<body>
	<div class="titulo">
		&nbsp;&nbsp;<input type="image" src="../../Imagenes/Inicio.png" style="vertical-align: middle;" onclick="cambio_pagina('../Menu.php');"><span style="vertical-align: middle;"> - Procesos - Modificacion de TRD</span>
	</div>
	<div class="busqueda">
		<form name="bus"><br>
		...
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;Buscar&nbsp;&nbsp;&nbsp;&nbsp;" class="boton" onclick="BusquedaTRD('Modificar');"></td>
		</tr></table>
		</form>
	</div>
